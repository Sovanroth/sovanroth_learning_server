...
export class UserService {
  ...
  async forgotPassword(email: string): Promise<string> {
    ...
    await transporter.sendMail({
      ...
      text: `To reset your password, please use the following link: https://localhost:3001/forgot-password/reset-password/${resetToken}`,
      html: `
      <p>Hello,</p>
      <p>You have requested to reset your password. Click the link below to reset your password:</p>
      <p><a href="https://localhost:3001/forgot-password/reset-password/${resetToken}">Reset Password</a></p>
